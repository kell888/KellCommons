...
using KellCommons.Mime;
using System.Text.RegularExpressions;

namespace KellCommons.Mail
{
    /// <summary>
            ...
            foreach (string key in entity.Headers.AllKeys)
            {
                ...
                switch (key.ToLowerInvariant())
                {
                    ...
                    case MailHeaders.ReplyTo:
                        message.ReplyTo = MailMessageEx.CreateMailAddress(value);//ReplyToList.Add(MailMessageEx.CreateMailAddress(value));
                        break;
