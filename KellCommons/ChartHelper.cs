...
namespace DotNet.Framework.Common
{
    ...
    public class ChartHelper
    {
        ...
        dotnetCHARTING.SeriesCollection getRandomData2(System.Data.DataTable table, string x, string y)
        {
            dotnetCHARTING.SeriesCollection SC = new dotnetCHARTING.SeriesCollection();
        ...
        public void Create(dotnetCHARTING.Chart chart, string title, System.Data.DataTable table, string xColumn, string yColumn, string style, int displayNum)
        {
            dotnetCHARTING.SeriesCollection SC = new dotnetCHARTING.SeriesCollection();
            DataView view = new DataView(table);
            view.Sort = yColumn + "  desc";
            ...
            if (other)
            {
                dotnetCHARTING.Series s = new dotnetCHARTING.Series("其他");
                s.Elements.Add(otherE);
                SC.Add(s);
            }
            otherE.YValue = otherSum;
        ...
        public void Pie2(dotnetCHARTING.Chart chart, string title, System.Data.DataTable table, string xColumn, string yColumn, string style, int displayNum, string targetUrl)
        {
